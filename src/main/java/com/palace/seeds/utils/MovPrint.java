...
public class MovPrint {
	...
	public static void pInt(int val){
		pInt("", val);
	}
	public static void pInt(String msg,int val){
		System.out.println("msg:"+msg+";sr:"+val+";"+"len:"+Integer.toBinaryString(val).length()+":"+Integer.toBinaryString(val));
	}
	
	public static void pLong(long val){
		pLong("",val);
	}
	public static void pLong(String msg,long val){
		System.out.println("msg:"+msg+";sr:"+val+";len:"+Long.toBinaryString(val).length()+":"+Long.toBinaryString(val));
	}
	
	 String str = new String(new byte[]{0x6a, 0x75, 0x6c, 0x79});
     String str1 = new String(new byte[]{0x64, 0x6f, 0x6e, 0x67, 0x67, 0x75, 0x61});
     public static byte[] $$() {
	        return new byte[]{
